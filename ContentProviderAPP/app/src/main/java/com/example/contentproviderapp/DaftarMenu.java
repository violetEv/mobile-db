...
public class DaftarMenu extends ContentProvider {
    static final String PROVIDER_NAME = "com.example.contentproviderapp.DaftarMenu";
    static final String URL = "content://" + PROVIDER_NAME + "/menu";
    static final Uri CONTENT_URI = Uri.parse(URL);

    static final String id = "id";
    static final String name = "nama_menu";
